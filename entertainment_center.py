...
cinema_paradiso = media.Movie("Cinema Paradiso",
                              ...
                              "/86/CinemaParadiso.jpg",
                              "https://www.youtube.com/watch?v=C2-GX0Tltgw")

leon = media.Movie("Leon", "https://upload.wikimedia.org/wikipedia/en/0/03"
                           "/Leon-poster.jpg",
...
children_of_heaven = media.Movie("Children of Heaven",
                                 ...
                                 "/f/f7/Children_of_heaven.jpg",
                                 "https://www.youtube.com/watch?v=dqxvZeQsVzY")

look_of_silence = media.Movie("Look of Silence",
                              "https://upload.wikimedia.org/wikipedia/en/7"
                              "/77/The_Look_of_Silence_%282014_film%29.jpg",
                              "https://www.youtube.com/watch?v=aA_ZHAs4M9k")

movies = [cinema_paradiso, leon, shawshank, life_is_beautiful,
          children_of_heaven, look_of_silence]
